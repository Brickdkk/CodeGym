    ...
    >
      <Card className="border-white/10 bg-black/60 backdrop-blur-md shadow-2xl">
        ...
        <CardContent className="space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="px-3 text-muted-foreground bg-black/60">o continua con</span>
            </div>
          </div>
        ...
        <CardFooter className="flex justify-center text-sm text-muted-foreground pb-6">
          ...
          <a href="/register" className="ml-1 text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
            Registrate
          </a>
        </CardFooter>
      </Card>
